            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="w-9 h-9 rounded-full bg-gray-200 flex items-center justify-center border hover:ring-2 hover:ring-blue-400 transition focus:outline-none"
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuItem asChild>
                  <Link to="/hospital/my-profile">My Profile</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
